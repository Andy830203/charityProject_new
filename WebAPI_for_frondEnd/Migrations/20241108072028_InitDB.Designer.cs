...
namespace WebAPI_for_frondEnd.Migrations
{
    ...
    [Migration("20241108072028_InitDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.CommentImg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.EventCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.EventImg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.EventLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.EventPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.LevelExp", b =>
                {
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.LocationImg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.MemberAccess", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.MemberStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.ProductImg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.SignUp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Staff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.StaffAccess", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.StaffStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.CartItem", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.Member", "BuyerNavigation")
                        .WithMany("CartItems")
                        .HasForeignKey("Buyer")
                        .HasConstraintName("cart_item_buyer_fk");

                    b.HasOne("WebAPI_for_frondEnd.Models.Product", "PIdNavigation")
                        .WithMany("CartItems")
                        .HasForeignKey("PId")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Comment", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.Event", "EIdNavigation")
                        .WithMany("Comments")
                        .HasForeignKey("EId")
                        .HasConstraintName("comment_e_id_fk");

                    b.HasOne("WebAPI_for_frondEnd.Models.Member", "MIdNavigation")
                        .WithMany("Comments")
                        .HasForeignKey("MId")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.CommentImg", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.Comment", "CIdNavigation")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Event", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.EventCategory", "Category")
                        .WithMany("Events")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("events_category_id_fk");

                    b.HasOne("WebAPI_for_frondEnd.Models.Member", "Organizer")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.EventLocation", b =>
                {
                    ...
                    b.HasOne("WebAPI_for_frondEnd.Models.Location", "LIdNavigation")
                        .WithMany("EventLocations")
                        .HasForeignKey("LId")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Member", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.MemberAccess", "AccessNavigation")
                        .WithMany("Members")
                        .HasForeignKey("Access")
                        .HasConstraintName("member_access_fk");

                    b.HasOne("WebAPI_for_frondEnd.Models.MemberStatus", "StatusNavigation")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Order", b =>
                {
                    ...
                    b.HasOne("WebAPI_for_frondEnd.Models.OrderStatus", "StatusNavigation")
                        .WithMany("Orders")
                        .HasForeignKey("Status")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.OrderItem", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.Order", "OIdNavigation")
                        .WithMany("OrderItems")
                        .HasForeignKey("OId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Product", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.ProductCategory", "CategoryNavigation")
                        .WithMany("Products")
                        .HasForeignKey("Category")
                        .HasConstraintName("p_category_fk");

                    b.HasOne("WebAPI_for_frondEnd.Models.Member", "SellerNavigation")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.SignUp", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.Member", "ApplicantNavigation")
                        .WithMany("SignUps")
                        .HasForeignKey("Applicant")
                        .HasConstraintName("su_applicant");

                    b.HasOne("WebAPI_for_frondEnd.Models.EventPeriod", "Ep")
                        .WithMany("SignUps")
                        .HasForeignKey("EpId")
            ...
            modelBuilder.Entity("WebAPI_for_frondEnd.Models.Staff", b =>
                {
                    b.HasOne("WebAPI_for_frondEnd.Models.StaffAccess", "AccessNavigation")
                        .WithMany("Staff")
                        .HasForeignKey("Access")
                        .HasConstraintName("staff_access_fk");

                    b.HasOne("WebAPI_for_frondEnd.Models.StaffStatus", "StatusNavigation")
                        .WithMany("Staff")
                        .HasForeignKey("Status")
