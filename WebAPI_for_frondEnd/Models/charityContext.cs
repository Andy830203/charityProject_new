...
namespace WebAPI_for_frondEnd.Models
{
    public partial class charityContext : DbContext
    {
        ...
        public virtual DbSet<Collection> Collection { get; set; } = default!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // 加入 Collection 的資料表映射設定
            modelBuilder.Entity<Collection>(entity =>
            {
                entity.HasKey(e => e.Id).HasName("collection_id_pk");

                entity.ToTable("collections"); // 明確指定資料表名稱為 collections

                entity.Property(e => e.Id).HasColumnName("id");
                entity.Property(e => e.MemberId).HasColumnName("MemberId");
                entity.Property(e => e.eventId).HasColumnName("EventId"); // 修正為小寫的 eventId
                entity.Property(e => e.attendance).HasColumnName("attendance"); // 修正為小寫的 attendance
